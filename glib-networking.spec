...
Source0  : https://download.gnome.org/sources/glib-networking/2.80/glib-networking-2.80.0.tar.xz
...
%prep
%setup -q -n glib-networking-2.80.0
cd %{_builddir}/glib-networking-2.80.0
pushd ..
cp -a glib-networking-2.80.0 build32
popd
pushd ..
cp -a glib-networking-2.80.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710887082
