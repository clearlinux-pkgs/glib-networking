...
Source0  : https://download.gnome.org/sources/glib-networking/2.60/glib-networking-2.60.1.tar.xz
...
%prep
%setup -q -n glib-networking-2.60.1
pushd ..
cp -a glib-networking-2.60.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1554228728
