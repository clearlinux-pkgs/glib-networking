...
Source0  : https://download.gnome.org/sources/glib-networking/2.62/glib-networking-2.62.1.tar.xz
...
%prep
%setup -q -n glib-networking-2.62.1
pushd ..
cp -a glib-networking-2.62.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570462321
