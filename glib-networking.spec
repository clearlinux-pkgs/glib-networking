...
Source0  : https://download.gnome.org/sources/glib-networking/2.60/glib-networking-2.60.0.1.tar.xz
...
%prep
%setup -q -n glib-networking-2.60.0.1
pushd ..
cp -a glib-networking-2.60.0.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1552436242
...
meson --libdir=/usr/lib32 --prefix /usr --buildtype=plain -Dlibproxy=enabled -Dgnutls=enabled -Dlibproxy=disabled -Dopenssl=disabled builddir
ninja -v -C builddir
popd
