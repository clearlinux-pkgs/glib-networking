...
Source0  : https://download.gnome.org/sources/glib-networking/2.68/glib-networking-2.68.0.tar.xz
...
%prep
%setup -q -n glib-networking-2.68.0
cd %{_builddir}/glib-networking-2.68.0
pushd ..
cp -a glib-networking-2.68.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618928643
...
cp %{_builddir}/glib-networking-2.68.0/COPYING %{buildroot}/usr/share/package-licenses/glib-networking/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
