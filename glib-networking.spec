...
Source0  : https://download.gnome.org/sources/glib-networking/2.60/glib-networking-2.60.3.tar.xz
...
%prep
%setup -q -n glib-networking-2.60.3
pushd ..
cp -a glib-networking-2.60.3 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1560173546
export AR=gcc-ar
