...
Source0  : https://download.gnome.org/sources/glib-networking/2.64/glib-networking-2.64.1.tar.xz
...
%prep
%setup -q -n glib-networking-2.64.1
cd %{_builddir}/glib-networking-2.64.1
pushd ..
cp -a glib-networking-2.64.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585582920
...
cp %{_builddir}/glib-networking-2.64.1/COPYING %{buildroot}/usr/share/package-licenses/glib-networking/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
