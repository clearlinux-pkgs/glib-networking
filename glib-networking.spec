...
Source0  : https://download.gnome.org/sources/glib-networking/2.62/glib-networking-2.62.3.tar.xz
...
%prep
%setup -q -n glib-networking-2.62.3
cd %{_builddir}/glib-networking-2.62.3
pushd ..
cp -a glib-networking-2.62.3 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578332088
...
cp %{_builddir}/glib-networking-2.62.3/COPYING %{buildroot}/usr/share/package-licenses/glib-networking/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32
