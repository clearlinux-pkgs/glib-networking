...
Source0  : https://download.gnome.org/sources/glib-networking/2.78/glib-networking-2.78.1.tar.xz
...
%prep
%setup -q -n glib-networking-2.78.1
cd %{_builddir}/glib-networking-2.78.1
pushd ..
cp -a glib-networking-2.78.1 build32
popd
pushd ..
cp -a glib-networking-2.78.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709739015
