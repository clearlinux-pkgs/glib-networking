...
pushd ..
cp -a glib-networking-2.64.2 build32
popd
...
cp %{_builddir}/glib-networking-2.64.2/COPYING %{buildroot}/usr/share/package-licenses/glib-networking/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
